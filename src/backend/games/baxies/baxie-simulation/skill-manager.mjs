export default class SkillManager {
  static skills = [
    { func: "tidalShield", cost: 45, cooldown: 15, image: "water-tidal-shield",
      description: "Shields all allies for 20% of max Stamina for 2 turns.",
    },
    { func: "bubbleTrap", cost: 40, cooldown: 15, image: "water-bubble-trap",
      description: "100% damage and 20% chance to silence the enemy for 1 turn."
    },
    { func: "oceansEmbrace", cost: 50, cooldown: 15, image: "water-oceans-embrace",
      description: "Heals lowest-HP ally for 15% HP and grants them +5 Defense for 2 turns."
    },
    { func: "voltOverload", cost: 50, cooldown: 15, image: "electric-volt-overload",
    ...
    { func: "stormBreaker", cost: 40, cooldown: 15, image: "electric-storm-breaker",
      description: "50% damage to all enemies. Stunned enemies take +20% extra damage this turn."
    },
    { func: "shadowStrike", cost: 50, cooldown: 15, image: "shadow-shadow-strike",
      description: "Ignores 20% of enemy Defense, lifesteals 15% of damage dealt.",
    },
    { func: "cursedChains", cost: 40, cooldown: 15, image: "shadow-cursed-chains",
    ...
    { func: "soulFeast", cost: 30, cooldown: 15, image: "shadow-soul-feast",
