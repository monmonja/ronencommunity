import 'phaser';
import { GAME_WIDTH, GAME_HEIGHT, SLOT_CAPACITY, INITIAL_SHUFFLES, INITIAL_UNDOS, INITIAL_RESTARTS } from '../constants.mjs';
...
export default class UIScene extends Phaser.Scene {
  ...
  createButton(x, y, text, callback, color = 0x1E90FF) {
    ...
    buttonContainer.setSize(180, 56).setInteractive({ useHandCursor: true });
